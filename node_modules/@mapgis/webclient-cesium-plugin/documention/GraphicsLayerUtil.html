<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">GraphicsLayerUtil</span>
...
<article>
    ...
    <h4 class="name" id="GraphicsLayerUtil">
        <a class="href-link" href="#GraphicsLayerUtil">#</a>
        
        <span class="code-name" id="GraphicsLayerUtil" style="font-size:30px">
            
                new GraphicsLayerUtil<span class="signature">()</span>
