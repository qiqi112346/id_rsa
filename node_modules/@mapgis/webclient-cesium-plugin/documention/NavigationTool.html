        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">NavigationTool</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="NavigationTool">
        <a class="href-link" href="#NavigationTool">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new NavigationTool<span class="signature">(viewer, options)</span>
    ...
    <div class="description">
        <p>A mixin which adds the Compass/Navigation widget to the Viewer widget.
Rather than being called directly, this function is normally passed as
a parameter to <code>Viewer#extend</code>, as shown in the example below.</p>
    </div>
...
<span class="param-type">Viewer</span>
  ...
  <td class="description last"><p>The viewer instance.</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>viewer is required.</p></div>
...
<span class="param-type">Cesium.DeveloperError</span>
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>var viewer = new Cesium.Viewer('cesiumContainer');
viewer.extend(NavigationTool);</code></pre>
    ...
    <h4 class="name" id=".mixinWidget">
        <a class="href-link" href="#.mixinWidget">#</a>
        ...
        <span class="code-name" style="font-size:30px">
                ...
                mixinWidget<span class="signature">()</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>cesiumNavigation对象</p></div>
    
    
    <div class='column is-5 has-text-left'>
        <label>类型: </label>
        
<span class="param-type">CesiumNavigation</span>
