...
const { S3MTileset } = zondy.cesium
// ES6引入方式
import { S3MTileset } from "@mapgis/webclient-cesium-plugin"

// 服务基地址
const url = "//www.supermapol.com/realspace/services/3D-BIMBaoZha-2/rest/realspace"
// 添加S3MTileSet
const s3mTileSet = await S3MTileset.fromUrl(url, {
   // 是否显示s3m模型
   isVisible: true,
   context: viewer.scene._context
 })
viewer.scene.primitives.add(s3mTileSet)</code></pre>
