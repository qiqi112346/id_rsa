...
<head>
  ...
  <title> MapGISDynamicLabelCollection</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">MapGISDynamicLabelCollection</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="MapGISDynamicLabelCollection">
        <a class="href-link" href="#MapGISDynamicLabelCollection">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new MapGISDynamicLabelCollection<span class="signature">(options)</span>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>要素JSON的请求资源路径</p></td>
</tr>
...
<span class="param-type">Array.&lt;LabelClass></span>
  ...
  <td class="description last"><p>注记样式</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>开启卷帘对比分析</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>单独控制该图层是否进行反转。小于0不反转，大于0时反转，等于0失效。该属性的控制优先级高于<code>Scene#swipeController</code>中的inverse属性.若要取消该属性对本图层的独立控制需要将该属性置为0。</p></td>
</tr>
...
<h4 class="name" id="swipeEnabled">
    <a class="href-link" href="#swipeEnabled">#</a>
...
<h4 class="name" id="swipeInverse">
    <a class="href-link" href="#swipeInverse">#</a>
...
<div class="description">
    <p>单独控制该图层是否进行反转，小于0不反转，大于0时反转，等于0失效。该属性的控制优先级高于<code>Scene#swipeController</code>中的inverse属性.若要取消该属性对本图层的独立控制需要将该属性置为0.</p>
</div>
...
<dl class="details">
    ...
    <h4 class="name" id="addLabelByFeatures">
        <a class="href-link" href="#addLabelByFeatures">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                addLabelByFeatures<span class="signature">(features, labelClass)</span>
...
<span class="param-type">Array.&lt;Feature></span>
  ...
  <td class="description last"><p>要素列表,要素的符号必须为TextSymbol及其派生类，且TextSymbol上text存在</p></td>
</tr>
...
<span class="param-type">LabelClass</span>
  ...
  <td class="description last"><p>注记样式，仅支持渲染样式的改变</p></td>
</tr>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id="removeLabelByFeatures">
        <a class="href-link" href="#removeLabelByFeatures">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                removeLabelByFeatures<span class="signature">(features)</span>
...
<span class="param-type">Array.&lt;Feature></span>
  ...
  <td class="description last"><p>要素列表</p></td>
</tr>
