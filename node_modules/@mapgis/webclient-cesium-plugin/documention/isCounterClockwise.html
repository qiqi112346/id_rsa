...
<head>
  ...
  <title> isCounterClockwise</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">isCounterClockwise</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="isCounterClockwise">
        <a class="href-link" href="#isCounterClockwise">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new isCounterClockwise<span class="signature">(viewer, options)</span>
...
<span class="param-type">Array.&lt;Cesium.Cartesian3></span>
  ...
  <td class="description last"><p>剖切点坐标数组 笛卡尔坐标</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>excavateSurfaceHeight</code></td>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>剖切面底面高度</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>excavateSurfaceMaxHeight</code></td>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>剖切面最大高度</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>splitNum</code></td>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>剖切点分割密度（该参数已经废弃，请使用samplePrecision参数设置采样精度）</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>采样精度(采样间隔，平面距离，单位米)</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>groundDiffuseMap</code></td>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>地形剖切体底面颜色纹理资源路径</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>wallDiffuseMap</code></td>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>地形剖切体剖切面颜色纹理资源路径</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const { RoamParticle } = zondy.cesium
// ES6引入方式
...
// 笛卡尔坐标下的剖切点坐标，三个以上
terrainPlan.updateData(positions);</code></pre>
