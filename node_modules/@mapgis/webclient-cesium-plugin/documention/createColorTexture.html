...
<head>
  ...
  <title> createColorTexture</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">createColorTexture</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="createColorTexture">
        <a class="href-link" href="#createColorTexture">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new createColorTexture<span class="signature">(options)</span>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const { SkyLineAnalysis } = zondy.cesium// ES6引入方式import { SkyLineAnalysis } from "@mapgis/webclient-cesium-plugin"const manager = scene.VisualAnalysisManager;const skyLineAn = new SkyLineAnalysis(     {          scene: scene,          color: new Cesium.Color(0.5, 0.8, 0.3),          analysisEndCallBack: getPositionCallBack     });  manager.add(skyLineAn);  function getPositionCallBack(result) {}</code></pre>
