        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">MapGISM3DSet</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="MapGISM3DSet">
        <a class="href-link" href="#MapGISM3DSet">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new MapGISM3DSet<span class="signature">()</span>
...
<a href='#example1'>1、加载M3D</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#sceneLayer' target='_blank'>2、场景图层</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#modelCacheLayer' target='_blank'>3、模型缓存图层</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#clientQuery' target='_blank'>4、客户端查询</a><br>
<a href='http://webclient.smaryun.com/#/modules/cesium/edit/modelEditor/m3d-model-editor' target='_blank'>5、模型编辑(M3D)</a><br>
<a href='http://webclient.smaryun.com/#/modules/cesium/analyse/compareAnalyse/roller-shutter' target='_blank'>6、卷帘</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#commonAnalyse' target='_blank'>7、三维分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#modelAnalyse' target='_blank'>8、模型分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#geologyAnalyse' target='_blank'>9、地质体分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#themeLayer' target='_blank'>10、专题图</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#commonVisualization' target='_blank'>11、场景美化</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#postEffect' target='_blank'>12、后处理特效</a><br>
<h5>支持如下方法：</h5>
<a href='#fromUrl'>[1、通过ArcGIS地图服务的url获取ArcGISMapServerImageryProvider对象]</a><br/></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='example1'>加载M3D</h7></p>
...
MapGISM3DSet.fromUrl(options.url, options).then(m3dset => {
  ...
  viewer.zoomTo(m3dset)
    ...
    <div class="description">
        <p>通过MapGIS M3D服务的url获取MapGISM3DSet对象<a id='fromUrl'/></p>
    </div>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>实例化对象时提供的额外配置参数，若该对象中包含构造参数则会覆盖对应的构造参数，参考<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/MapGISM3DSet.html' target='_blank'>MapGISM3DSet</a>的初始化参数</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>详见<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/MapGISM3DSet.html' target='_blank'>Cesium.MapGISM3DSet</a></p></div>
