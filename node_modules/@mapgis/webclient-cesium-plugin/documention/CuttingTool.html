...
<span class="param-type">Viewer</span>
  ...
  <td class="description last"><p>三维视图对象，<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/index.html' target='_blank'>详见Cesium.Viewer</a></p></td>
</tr>
...
<span class="param-type">Array.&lt;(Cesium.MapGISM3DSet|Cesium.Cesium3DTileset)></span>
  ...
  <td class="description last"><p>要剖切的图层对象数组，
...
<a href='http://webclient.smaryun.com/#/modules/cesium/analyse/modelAnalyse/model-cutting' target='_blank'>1、动态剖切</a><br>
<a href='http://webclient.smaryun.com/#/modules/cesium/analyse/geologyAnalyse/model-banding' target='_blank'>2、地质体封边</a><br>
<a href='http://webclient.smaryun.com/#/modules/cesium/analyse/terrainAnalyse/terrain-excavation' target='_blank'>3、地形开挖</a>
<h5>支持如下方法：</h5>
<a href='#createModelCuttingPlane'>[1、创建模型裁剪面]</a><br/>
<a href='#changePlaneColor'>[2、修改辅助剖切面颜色]</a><br/>
<a href='#createModelCuttingPlaneFromLine'>[3、通过直线，绘制模型裁剪面]</a><br/>
<a href='#createModelCuttingPlaneFromPolyline'>[4、通过折线，绘制模型裁剪面，请提两个以上的点，否则不执行剖切分析]</a><br/>
<a href='#createModelCuttingVolume'>[5、通过边界区域，以及最小最大高程，构建裁剪体]</a><br/>
<a href='#createModelCuttingPolygon'>[6、多边形几何裁剪]</a><br/>
<a href='#removeAll'>[7、移除所有裁剪面]</a><br/>
<a href='#enabled'>[8、开关当前被CuttingTool管理的裁剪体]</a><br/>
<a href='#showCuttingPlane'>[9、显示或隐藏所有辅助剖切面(体)]</a><br/></p>
...
<div class="description">
    <p>是否支持开挖地形 打开后通过<a href="CuttingTool.html#createModelCuttingVolume"><code>CuttingTool#createModelCuttingVolume</code></a> 和 <a href="CuttingTool.html#createModelCuttingPlaneFromPolyline"><code>CuttingTool#createModelCuttingPlaneFromPolyline</code></a> 创建的裁剪体会同时对地形做裁剪。
<a href="CuttingTool.html#createModelCuttingPlaneFromPolyline"><code>CuttingTool#createModelCuttingPlaneFromPolyline</code></a> 添加地形支持时由于缺少高度所以不会开启剖切面封边</p>
</div>
...
<dl class="details">
    ...
    <div class="description">
        <p>修改辅助剖切面颜色<a id='changePlaneColor'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>创建模型裁剪面，支持MapGISM3DSet和Cesium3DTileset<a id='createModelCuttingPlane'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>通过直线，绘制模型裁剪面，支持MapGISM3DSet和Cesium3DTileset<a id='createModelCuttingPlaneFromLine'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>通过折线，绘制模型裁剪面，请提两个以上的点，否则不执行剖切分析，支持MapGISM3DSet和Cesium3DTileset<a id='createModelCuttingPlaneFromPolyline'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>多边形几何裁剪<br/><a id='createModelCuttingPolygon'/>
通过边界区域，以及高程，构建裁剪几何体。支持凹多边形裁剪，但对封边效果支持不好，仅支持MapGISM3DSet</p>
    </div>
...
cutTool.createModelCuttingPolygon(positions, -1000, 500, {
    ...
    <div class="description">
        <p>通过边界区域，以及最小最大高程，构建裁剪体，支持MapGISM3DSet和Cesium3DTileset<a id='createModelCuttingVolume'/></p>
    </div>
...
<span class="param-type">String</span>
      ...
      <td class="default">
          ...
          MAPGIS_BASE_URL+'webclient-cesium-plugin-resource/assets/images/sandydrysoil-albedo2b.jpg'
...
<span class="param-type">String</span>
      ...
      <td class="default">
          ...
          MAPGIS_BASE_URL+'webclient-cesium-plugin-resource/assets/images/wall-texture-default.jpg'
...
<dl class="details">
    ...
    <div class="description">
        <p>feat:2105 地形支持剖切及纹理封边
开关当前被CuttingTool管理的裁剪体<a id='enabled'/></p>
    </div>
...
cutTool.removeAll();</code></pre>
    ...
    <div class="description">
        <p>显示或隐藏所有辅助剖切面(体)<a id='showCuttingPlane'/></p>
    </div>
