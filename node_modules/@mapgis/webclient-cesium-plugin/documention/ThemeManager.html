        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">ThemeManager</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="ThemeManager">
        <a class="href-link" href="#ThemeManager">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new ThemeManager<span class="signature">(viewer, options)</span>
...
<span class="param-type">Cesium.Color</span>
  ...
  <td class="description last"><p>标注颜色，<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/index.html?classFilter=Color' target='_blank'>详见Cesium.Color</a></p></td>
</tr>
...
<a href='#example1'>1、统计图</a>
<h5>支持如下方法：</h5>
<a href='#query'>[1、查询]</a><br/>
<a href='#addByQueryResult'>[1、根据查询结果添加专题图]</a><br/>
<a href='#addByGeoJson'>[1、根据统一的geoJson格式添加专题图]</a><br/>
<a href='#remove'>[1、删除专题图]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>统计图</h7></p>
...
<h4 class="name" id="addExtrudedHeight">
    <a class="href-link" href="#addExtrudedHeight">#</a>
...
<h4 class="name" id="addGeoGeometry">
    <a class="href-link" href="#addGeoGeometry">#</a>
...
<div class="description">
    <p>解析GeoJson数据时，是否绘制polygon的Geometry</p>
</div>
...
<h4 class="name" id="attributeName">
    <a class="href-link" href="#attributeName">#</a>
...
<h4 class="name" id="heightScale">
    <a class="href-link" href="#heightScale">#</a>
...
<h4 class="name" id="nearFarScalar">
    <a class="href-link" href="#nearFarScalar">#</a>
...
<h4 class="name" id="textColor">
    <a class="href-link" href="#textColor">#</a>
...
<h4 class="name" id="textFont">
    <a class="href-link" href="#textFont">#</a>
...
<h4 class="name" id="textHeightOffset">
    <a class="href-link" href="#textHeightOffset">#</a>
...
<dl class="details">
    ...
    <h4 class="name" id="addByGeoJson">
        <a class="href-link" href="#addByGeoJson">#</a>
    ...
    <div class="description">
        <p>根据统一的geoJson格式添加专题图<a id='addByGeoJson'/></p>
    </div>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>GeoJson格式数据</p></td>
</tr>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>专题图类型</p></td>
</tr>
...
<dl class="details">
    ...
    <h4 class="name" id="addByQueryResult">
        <a class="href-link" href="#addByQueryResult">#</a>
    ...
    <div class="description">
        <p>根据查询结果添加专题图<a id='addByQueryResult'/></p>
    </div>
...
<dl class="details">
    ...
    <h4 class="name" id="query">
        <a class="href-link" href="#query">#</a>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>Rest服务查询url</p></td>
</tr>
