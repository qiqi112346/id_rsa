...
<span class="param-type">Cesium.Color</span>
  ...
  <td class="description last"><p>等高线颜色默认为红色，<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/index.html?classFilter=Color' target='_blank'>详见Cesium.Color</a></p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>aspectArrowImage</code></td>
...
<span class="param-type">String</span>
      ...
      <td class="default">
          ...
          MAPGIS_BASE_URL+'webclient-cesium-plugin-resource/assets/textures/arrow3.png'
      
      </td>
  

  <td class="description last"><p>坡向箭头图片地址</p></td>
</tr>
...
<a href='#example1'>1、坡度分析</a><br>
<a href='#example2'>2、坡向分析</a><br>
<a href='#example3'>3、坡度坡向分析</a><br>
<a href='#example4'>4、地形压平</a><br>
<a href='#example5'>5、结束分析</a><br>
<h5>支持如下方法：</h5>
<a href='#changeContours'>[1、修改等高线宽度，间距和颜色]</a><br/>
<a href='#changeAnalyseArea'>[2、更新分析区域]</a><br/>
<a href='#changeColorTable'>[3、更新色表]</a><br/>
<a href='#changeColorTableDis'>[4、更新色表间距值]</a><br/>
<a href='#changeArrowAspectRepeat'>[5、修改坡向箭头密度]</a><br/>
<a href='#updateMaterial'>[6、开启地形分析，坡度，坡向和等值线]</a><br/>
<a href='#updateElevationBandMaterial'>[7、开启地形分析，坡度，坡向和等值线]</a><br/>
<a href='#calculateSlopeAndAspect'>[8、根据输入屏幕坐标查询坡度坡向值]</a><br/>
<a href='#queryInfo'>[9、右键点击查询坡度坡向值]</a><br/>
<a href='#removeQueryInfo'>[10、移除点击查询坡度坡向值事件]</a><br/>
<a href='#destroy'>[11、移除坡度坡向，等值面，等高线等分析结果]</a><br/>
<a href='#terrainFlatten'>[12、地形压平]</a><br/>
<a href='#removeTerrainFlatten'>[13、移除地形压平]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>坡度分析</h7></p>
...
drawElement.startDrawingPolygon({
    callback: function (result) {
        ...
        <p class="code-caption"><h7 id='example2'>坡向分析</h7></p>
...
drawElement.startDrawingPolygon({
    callback: function (result) {
        ...
        <p class="code-caption"><h7 id='example3'>坡度坡向分析</h7></p>
...
drawElement.startDrawingPolygon({
    callback: function (result) {
        ...
        <p class="code-caption"><h7 id='example4'>地形压平</h7></p>
...
drawElement.startDrawingPolygon({
    callback: function (result) {
       ...
       drawElement.stopDrawing()
        ...
        <p class="code-caption"><h7 id='example5'>结束分析</h7></p>
    
    
        <pre class="prettyprint"><code>terrainAnalyse.destroy();</code></pre>
    ...
    <div class="description">
        <p>根据输入屏幕坐标查询坡度坡向值<a id='calculateSlopeAndAspect'/></p>
    </div>
...
aspectDescription = result.aspectDescription</code></pre>
    ...
    <div class="description">
        <p>更新分析区域<a id='changeAnalyseArea'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>修改坡向箭头密度<a id='changeArrowAspectRepeat'/></p>
    </div>
...
changeArrowAspectRepeat(cartesian2);</code></pre>
    ...
    <div class="description">
        <p>更新色表<a id='changeColorTable'/></p>
    </div>
...
terrainAnalyse.changeColorTable(defaultColor,'elevation');</code></pre>
    ...
    <div class="description">
        <p>更新色表间距值<a id='changeColorTableDis'/></p>
    </div>
...
terrainAnalyse.changeColorTableDis(defaultColor,'elevation');</code></pre>
    ...
    <div class="description">
        <p>修改等高线宽度，间距和颜色<a id='changeContours'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>移除坡度坡向，等值面，等高线等分析结果<a id='destroy'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>右键点击查询坡度坡向值<a id='queryInfo'/></p>
    </div>
...
terrainAnalyse.queryInfo(getResult);</code></pre>
    ...
    <div class="description">
        <p>移除点击查询坡度坡向值事件<a id='removeQueryInfo'/></p>
    </div>
...
<dl class="details">
    ...
    <div class="description">
        <p>移除地形压平<a id='removeTerrainFlatten'/></p>
    </div>
...
<span class="param-type">Boolean</span>
    ...
    <div class="description">
        <p>开启地形等值面分析<a id='updateElevationBandMaterial'/></p>
    </div>
...
terrainAnalyse.updateElevationBandMaterial(bandPositions,false,100,1.0,0.0,colorsArray);</code></pre>
    ...
    <h4 class="name" id="updateMaterial">
        ...
        <span class="code-name" style="font-size:30px">
                ...
                updateMaterial<span class="signature">(inputShading)</span>
    ...
    <div class="description">
        <p>开启地形分析，坡度，坡向和等值线<a id='updateMaterial'/></p>
    </div>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>inputShading</code></td>
