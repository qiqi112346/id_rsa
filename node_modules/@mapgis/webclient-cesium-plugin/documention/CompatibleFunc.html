        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">CompatibleFunc</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="CompatibleFunc">
        <a class="href-link" href="#CompatibleFunc">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new CompatibleFunc<span class="signature">()</span>
...
<a href='#worldToWindowCoordinates'>[1、适配Cesium不同版本的worldToWindowCoordinates方法，将世界坐标中的位置转换为窗口坐标]</a><br/>
<a href='#fromGltfAsync'>[2、适配Cesium不同版本的fromGltfAsync方法，异步创建GLTF模型]</a><br/></p>
...
const windowCoordinates = CompatibleFunc.worldToWindowCoordinates(
  ...
  Cesium.Cartesian3.fromDegrees(0, 0, 0)
    ...
    <h4 class="name" id=".fromGltfAsync">
        <a class="href-link" href="#.fromGltfAsync">#</a>
        ...
        <span class="code-name" style="font-size:30px">
                ...
                fromGltfAsync<span class="signature">()</span>
    ...
    <div class="description">
        <p>适配Cesium不同版本的fromGltfAsync方法，异步创建GLTF模型。
Cesium1.122中该方法为Cesium.Model.fromGltfAsync。Cesium1.84中该方法为Cesium.Model.fromGltf。<a id='fromGltfAsync'></a></p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>fromGltfAsync方法</p></div>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id=".worldToWindowCoordinates">
        <a class="href-link" href="#.worldToWindowCoordinates">#</a>
        ...
        <span class="code-name" style="font-size:30px">
                ...
                worldToWindowCoordinates<span class="signature">()</span>
    ...
    <div class="description">
        <p>适配Cesium不同版本的worldToWindowCoordinates方法，将世界坐标中的位置转换为窗口坐标。
Cesium1.122中该方法为Cesium.SceneTransforms.worldToWindowCoordinates。Cesium1.84中该方法为Cesium.SceneTransforms.wgs84ToWindowCoordinates。<a id='worldToWindowCoordinates'></a></p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>worldToWindowCoordinates方法</p></div>
