        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">initializeOptions</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="initializeOptions">
        ...
        <span class="code-name" style="font-size:30px">
                ...
                new initializeOptions<span class="signature">(layer, viewer)</span>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>Cesium视图对象（仅在构造M3D对象时使用）</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>用于实例化对象的配置参数</p></div>
