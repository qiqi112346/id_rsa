...
<div class="description">
    <p>草图图形弧线类型。none不考虑弧度。geodesic大地线（或称为大圆线）。rhumb等角航线。目前绘制线、区、矩形时，该属性生效。</p>
</div>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7>三维草图线拓扑造区</h7></p>
...
<span class="param-type">Array.&lt;Polygon></span>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7>三维草图几何分割</h7></p>
...
const newSketchEditors = SketchEditor.split(polygon,polyline)</code></pre>
    ...
    <div class="description">
        <p>更新当前选中或区草图图形的某个顶点<a id='updateVertex'></a></p>
    </div>
