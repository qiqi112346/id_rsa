...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>限高颜色混合比例，0-1之间的数值</p></td>
</tr>
...
<a href='#example1'>1、限高分析</a><br>
<h5>支持如下方法：</h5>
<a href='#add'>[1、执行限高分析]</a><br/>
<a href='#remove'>[2、移除限高分析]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>限高分析</h7></p>
