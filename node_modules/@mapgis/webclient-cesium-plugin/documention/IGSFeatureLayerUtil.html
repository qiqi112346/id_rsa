<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">IGSFeatureLayerUtil</span>
...
<article>
    ...
    <h4 class="name" id="IGSFeatureLayerUtil">
        <a class="href-link" href="#IGSFeatureLayerUtil">#</a>
        
        <span class="code-name" id="IGSFeatureLayerUtil" style="font-size:30px">
            
                new IGSFeatureLayerUtil<span class="signature">()</span>
...
<a href='#toPrimitive'>[1、将单个要素或要素集合转换为Cesium原生Primitive的方法]</a><br/></p>
...
<span class="param-type">
             ...
             Array
                                ...
                                <td class="name"><code><p>将单个要素或要素集合转换为Cesium原生Primitive的方法</p></code></td>
                            </tr>
