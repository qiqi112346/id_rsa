        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">CustomProjection</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="CustomProjection">
        <a class="href-link" href="#CustomProjection">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new CustomProjection<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>实现自定义投影坐标系与地理坐标系经纬度（弧度表示）之间的投影变换</p>
    </div>
...
<span class="param-type">Ellipsoid</span>
  ...
  <td class="description last"><p>参考椭球体对象</p></td>
</tr>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>投影坐标系的通识文本（Well Known Text）</p></td>
</tr>
...
<h4 class="name" id="ellipsoid">
    <a class="href-link" href="#ellipsoid">#</a>
...
<dl class="details">
    ...
    <h4 class="name" id="project">
        ...
        <span class="code-name" style="font-size:30px">
                ...
                project<span class="signature">(cartographic, result<span class="signature-attributes">opt</span>)</span>
    ...
    <div class="description">
        <p>将地理坐标（弧度表示）投影到目标投影坐标系中，其高度保持不变，投影坐标以Cartesian3对象返回</p>
    </div>
...
<span class="param-type">Cartographic</span>
  ...
  <td class="description last"><p>用于投影变换的地理坐标（弧度表示）</p></td>
</tr>
...
<span class="param-type">Cartesian3</span>
  ...
  <td class="description last"><p>保存结果的Cartesian3对象，若未定义则创建新的Cartesian3对象并返回</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回指定的'result'，如果'result'未定义，则为包含矩形的Cartesian3新对象</p></div>
...
<span class="param-type">Cartesian3</span>
    ...
    <h4 class="name" id="unproject">
        <a class="href-link" href="#unproject">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                unproject<span class="signature">(cartesian, result<span class="signature-attributes">opt</span>)</span>
    ...
    <div class="description">
        <p>将投影坐标投影到地理坐标系中，其高度保持不变，投影坐标以Cartographic对象（以弧度为单位）返回</p>
    </div>
...
<span class="param-type">Cartesian3</span>
  ...
  <td class="description last"><p>用于反投影变换的投影坐标</p></td>
</tr>
...
<span class="param-type">Cartographic</span>
  ...
  <td class="description last"><p>保存结果的Cartographic对象，若未定义则创建新的Cartographic对象并返回</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回指定的'result'，如果'result'未定义，则为包含矩形的Cartographic新对象</p></div>
