        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">Viewer</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="Viewer">
        ...
        <span class="code-name" style="font-size:30px">
                ...
                new Viewer<span class="signature">()</span>
...
<dl class="details">
    ...
    <h4 class="name" id="createNavigationTool">
        <a class="href-link" href="#createNavigationTool">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                createNavigationTool<span class="signature">(options)</span>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>导航控件参数
example：
var options = {};
...
//用于启用或禁用指南针外环
options.enableCompassOuterRing= true;</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>三维笛卡尔坐标点</p></div>
...
<span class="param-type">Cartesian3</span>
    ...
    <h4 class="name" id="getCartesian3Position">
        <a class="href-link" href="#getCartesian3Position">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                getCartesian3Position<span class="signature">(screePosition, cartesian)</span>
    ...
    <div class="description">
        <p>根据屏幕坐标返回对应的世界坐标，支持拾取模型缓存、实体（Entity），图元（Primitive）、地形上的点坐标<br>
请注意如下几种情况无法返回世界坐标：<br>
1、当 <code>Scene#useDepthPicking</code> 设置为false时，无法拾取模型缓存、实体（Entity），图元（Primitive）上的点坐标，会返回undefined<br>
2、当 <code>Scene#pickTranslucentDepth</code> 设置为false，且模型缓存、实体（Entity），图元（Primitive）设置为半透明时，在鼠标移动事件中无法拾取点坐标，会返回undefined<br>
3、当 <code>Scene#mode</code> 设置为 <code>SceneMode#SCENE2D</code> 时 ，无法拾取实体（Entity），图元（Primitive）上点坐标的高程<br></p>
    </div>
...
<span class="param-type">Cesium.Cartesian3</span>
  ...
  <td class="description last"><p>返回的世界坐标</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回的世界坐标，当没有拾取到点坐标时，返回undefined</p></div>
...
<span class="param-type">undefined</span>
    ...
    <h4 class="name" id="hidePosition">
        <a class="href-link" href="#hidePosition">#</a>
...
<dl class="details">
    ...
    <h4 class="name" id="showPosition">
        <a class="href-link" href="#showPosition">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                showPosition<span class="signature">(elementId, options)</span>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>要显示的div的id</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>显示当前鼠标所在位置拾取到的级别</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>显示视图级别</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>element 状态栏的element</p></div>
...
<span class="param-type">Element</span>
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>webGlobe.showPosition('', {
     showHpr: true,
