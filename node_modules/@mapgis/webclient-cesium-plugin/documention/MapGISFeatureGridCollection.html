...
<head>
  ...
  <title> MapGISFeatureGridCollection</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">MapGISFeatureGridCollection</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="MapGISFeatureGridCollection">
        <a class="href-link" href="#MapGISFeatureGridCollection">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new MapGISFeatureGridCollection<span class="signature">(options)</span>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.debugGrid</code></td>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>开启debug网格</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.updateInterval</code></td>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>要素更新间隔。设置值过大时也会影响性能</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.maxTileCacheCount</code></td>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>最大的瓦片缓存数量</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>支持请求的最小级别，小于这个级别不会发送查询要素的请求</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>支持请求的最大级别，大于这个级别不会发送查询要素的请求</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.extent</code></td>
...
<span class="param-type">Extent</span>
  ...
  <td class="description last"><p>请求数据的范围，不在这个范围不会发送查询请求</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.idField</code></td>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>用于唯一标识要素的属性字段。多个网格会请求同样一个面要素，为了避免重复添加，增加要素属性字段用于标识唯一要素</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.translucency</code></td>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>设置图层透明度，只支持部分符号样式。</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>是否显示网格要素</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.renderer</code></td>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.lodStrategy</code></td>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>lod策略，'add'模式会一直添加要素，'replace'模式则是在瓦片更新时销毁上一级瓦片要素，添加下一级瓦片的要素。</p></td>
</tr>
...
<span class="param-type">Cesium.WebMercatorTilingScheme</span>
  ...
  <td class="description last"><p>瓦片网格划分方式，默认使用cesium的四叉树网格。</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.timeExtent</code></td>
  

  <td class="type">
  
      
<span class="param-type">TimeExtent</span>
  ...
  <td class="description last"><p>时间范围，仅显示在此时间范围内的要素，需要配合TimeInfo使用。</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>options.timeInfo</code></td>
  

  <td class="type">
  
      
<span class="param-type">TimeInfo</span>
  ...
  <td class="description last"><p>时间维度信息的描述</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const igsFeatureLayer = new IGSFeatureLayer({
     url: 'http://192.168.82.91:8089/igs/rest/services/Map/%E6%B9%96%E5%8C%97%E7%9C%814326/FeatureServer'
   })
...
<h4 class="name" id="debugGrid">
    <a class="href-link" href="#debugGrid">#</a>
