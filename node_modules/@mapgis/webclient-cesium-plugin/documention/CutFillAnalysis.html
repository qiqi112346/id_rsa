        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">CutFillAnalysis</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="CutFillAnalysis">
        <a class="href-link" href="#CutFillAnalysis">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new CutFillAnalysis<span class="signature">(viewer, options<span class="signature-attributes">opt</span>)</span>
...
<a href='#example1'>1、填挖方分析</a>
<h5>支持如下方法：</h5>
<a href='#start'>[1、开始分析]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>填挖方分析</h7></p>
...
<h4 class="name" id="cutVolume">
    <a class="href-link" href="#cutVolume">#</a>
...
<h4 class="name" id="dataType">
    <a class="href-link" href="#dataType">#</a>
...
<h4 class="name" id="dotsPolygonList">
    <a class="href-link" href="#dotsPolygonList">#</a>
...
<h4 class="name" id="fillVolume">
    <a class="href-link" href="#fillVolume">#</a>
...
<h4 class="name" id="heightBuff">
    <a class="href-link" href="#heightBuff">#</a>
...
<h4 class="name" id="relation">
    <a class="href-link" href="#relation">#</a>
...
<div class="description">
    <p>存储采样点与多边形的关系数组，在多边形内为true，不在多边形内为false</p>
</div>
...
<h4 class="name" id="xCellLength">
    <a class="href-link" href="#xCellLength">#</a>
...
<h4 class="name" id="xPaneNum">
    <a class="href-link" href="#xPaneNum">#</a>
...
<h4 class="name" id="yCellLength">
    <a class="href-link" href="#yCellLength">#</a>
...
<h4 class="name" id="yPaneNum">
    <a class="href-link" href="#yPaneNum">#</a>
...
<dl class="details">
    ...
    <h4 class="name" id="start">
        ...
        <span class="code-name" style="font-size:30px">
                ...
                start<span class="signature">(params)</span>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>最小最大经纬度值</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>成功返回 true</p></div>
