...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>三维地球场景的视图对象</p></td>
</tr>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>场景相机漫游工具的配置项</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>是否开启鼠标控制模式，开启后将进入全屏模式，此时相机视角可通过鼠标移动进行操作</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>是否开启动态移动步长，开启后将根据视角距离地面高度动态计算移动步长，<code>moveStep</code>参数将不再生效</p></td>
</tr>
...
<span class="param-type">Boolean</span>
  ...
  <td class="description last"><p>是否开启碰撞检测</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>鼠标灵敏度，该参数仅在鼠标控制模式下有效</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>移动步长，单位为米</p></td>
</tr>
...
<span class="param-type">Number</span>
  ...
  <td class="description last"><p>旋转步长，单位为度</p></td>
</tr>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>初始视角，参数与<code>Camera#setView</code>方法相同，开始漫游时视角将重置到该视角，若不设置则默认从当前视角开始漫游</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7>场景相机键盘漫游</h7></p>
...
<h4 class="name" id="enableCollisionDetection">
    <a class="href-link" href="#enableCollisionDetection">#</a>
...
<h4 class="name" id="enableDynamicMoveStep">
    <a class="href-link" href="#enableDynamicMoveStep">#</a>
...
<h4 class="name" id="enableMouseLook">
    <a class="href-link" href="#enableMouseLook">#</a>
...
<div class="description">
    <p>获取或设置当前是否开启鼠标操作功能，当该参数为true时，开启漫游后页面将进入全屏模式，由于浏览器安全策略
的限制，此时<code>start()</code>方法必需由一个用户手势触发（如主动点击按钮），而不能由程序被动触发</p>
</div>
...
<h4 class="name" id="initView">
    <a class="href-link" href="#initView">#</a>
...
<h4 class="name" id="mouseSensitivity">
    <a class="href-link" href="#mouseSensitivity">#</a>
...
<h4 class="name" id="moveStep">
    <a class="href-link" href="#moveStep">#</a>
...
<h4 class="name" id="rotateStep">
    <a class="href-link" href="#rotateStep">#</a>
...
<dl class="details">
    ...
    <div class="description">
        <p>停止场景相机漫游，若在全屏状态下，则无需调用该方法停止场景相机漫游，只需要按下<code>ESC</code>或<code>F11</code></p>
    </div>
