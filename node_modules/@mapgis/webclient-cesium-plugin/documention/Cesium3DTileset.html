        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">Cesium3DTileset</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="Cesium3DTileset">
        <a class="href-link" href="#Cesium3DTileset">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new Cesium3DTileset<span class="signature">()</span>
    ...
    <div class="description">
        <p>Cesium3DTileset对象，现已不支持通过构造函数(new Cesium3DTileset())的方式初始化图层，而是使用fromUrl方法构造图层</p>
    </div>
...
<a href='http://webclient.smaryun.com/#/modules/cesium/edit/modelEditor/m3d-model-editor' target='_blank'>2、模型编辑(M3D)</a><br>
<a href='http://webclient.smaryun.com/#/modules/cesium/analyse/compareAnalyse/roller-shutter' target='_blank'>3、卷帘</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#commonAnalyse' target='_blank'>4、三维分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#modelAnalyse' target='_blank'>5、模型分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#geologyAnalyse' target='_blank'>6、地质体分析</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#themeLayer' target='_blank'>7、专题图</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#commonVisualization' target='_blank'>8、场景美化</a><br>
<a href='http://webclient.smaryun.com/#/example-gallery/cesium#sceneLayer' target='_blank'>9、更多图层加载示例</a>
<h5>支持如下方法：</h5>
<a href='#fromUrl'>[1、通过URL来构造一个CesiumTerrainProvider对象]</a><br></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>添加一个Cesium3DTileset图层：原生接口开发</h7></p>
    
    
        <pre class="prettyprint"><code>// ES5引入方式
const { Cesium3DTileset } = zondy.cesium
// ES6引入方式
import { Cesium3DTileset } from "@mapgis/webclient-cesium-plugin"

const tileset = await Cesium3DTileset.fromUrl("http://webclient.smaryun.com:8200/3DData/ModelCache/3DTileset/1.0/dayantaresult/tileset.json")
viewer.scene.primitives.add(tileset)</code></pre>
    ...
    <div class="description">
        <p>通过URL来构造一个Cesium3DTileset对象</p>
    </div>
...
<span class="param-type">String</span>
  ...
  <td class="description last"><p>Cesium 3DTile模型服务的基地址</p></td>
</tr>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>额外的构造参数，参考<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/Cesium3DTileset.html' target='_blank'>MapGISM3DSet</a>的初始化参数</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的Cesium3DTileset对象</p></div>
