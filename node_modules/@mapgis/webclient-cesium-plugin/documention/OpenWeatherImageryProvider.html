...
<head>
  ...
  <title> OpenWeatherImageryProvider</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">OpenWeatherImageryProvider</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="OpenWeatherImageryProvider">
        <a class="href-link" href="#OpenWeatherImageryProvider">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new OpenWeatherImageryProvider<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>OpenWeatherMap服务provider供给器</p>
    </div>
...
<span class="param-type">Object</span>
  ...
  <td class="description last"><p>服务的平铺方案:经纬度 GeographicTilingScheme,web墨卡托 Cesium.WebMercatorTilingScheme</p></td>
</tr>
...
<div class="description">
    <p>Gets the proxy used by this provider.</p>
</div>
