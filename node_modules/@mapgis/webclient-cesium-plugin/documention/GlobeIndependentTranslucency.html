...
<head>
  ...
  <title> GlobeIndependentTranslucency</title>
  <!--[if lt IE 9]>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header id="page-title" class="page-title">
                    ...
                    <span class="page-title-sub">GlobeIndependentTranslucency</span>
                </header>
...
<article>
    ...
    <h4 class="name" id="GlobeIndependentTranslucency">
        <a class="href-link" href="#GlobeIndependentTranslucency">#</a>
        
        <span class="code-name" style="font-size:30px">
            
                new GlobeIndependentTranslucency<span class="signature">(viewer)</span>
...
<span class="param-type">Viewer</span>
  ...
  <td class="description last"><p>显示三维地球场景的对象</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7>地表透明独立控制</h7></p>
...
<h4 class="name" id="backFaceAlpha">
    <a class="href-link" href="#backFaceAlpha">#</a>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li>GlobeTranslucency#backFaceAlpha</li>
        </ul>
    </dd>
...
<h4 class="name" id="backFaceAlphaByDistance">
    <a class="href-link" href="#backFaceAlphaByDistance">#</a>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li>GlobeTranslucency#backFaceAlphaByDistance</li>
        </ul>
    </dd>
...
<h4 class="name" id="frontFaceAlpha">
    <a class="href-link" href="#frontFaceAlpha">#</a>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li>GlobeTranslucency#frontFaceAlpha</li>
        </ul>
    </dd>
...
<h4 class="name" id="frontFaceAlphaByDistance">
    <a class="href-link" href="#frontFaceAlphaByDistance">#</a>
...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li>GlobeTranslucency#frontFaceAlphaByDistance</li>
        </ul>
    </dd>
...
<h4 class="name" id="globeFaceAlpha">
    <a class="href-link" href="#globeFaceAlpha">#</a>
...
<div class="description">
    <p>地表的透明度，若设置该参数则<code>globeFaceAlphaByDistance</code>不生效</p>
</div>
...
<h4 class="name" id="globeFaceAlphaByDistance">
    <a class="href-link" href="#globeFaceAlphaByDistance">#</a>
...
<div class="description">
    <p>地表的透明度根据视点距离的变化范围，在<code>globeFaceAlpha</code>为<code>undefined</code>时生效</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-default">Default Value:</dt>
    <dd class="tag-default"><ul class="dummy">
            <li>new Cesium.NearFarScalar(3.0e5, 0.0, 3.0e6, 1.0)</li>
        </ul></dd>
...
<span class="param-type">Array.&lt;Cesium.ImageryLayer></span>


    </span>

<h4 class="name" id="imageryLayers">
    <a class="href-link" href="#imageryLayers">#</a>
...
<div class="description">
    <p>需要单独控制透明度的影像图层，可以通过数组的形式传入一个或多个影像图层对象</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-default">Default Value:</dt>
    <dd class="tag-default"><ul class="dummy">
            <li><code>Cesium.Rectangle.MAX_VALUE</code></li>
        </ul></dd>
