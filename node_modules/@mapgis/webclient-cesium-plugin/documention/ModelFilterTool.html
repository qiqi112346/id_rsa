...
<span class="param-type">Cesium.MapGISM3DSet</span>
  ...
  <td class="description last"><p>MapGISM3DSet对象，详见<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/MapGISM3DSet.html' target='_blank'>Cesium.MapGISM3DSet</a></p></td>
</tr>
...
<a href='#example1'>1、外包盒过滤</a><br>
<a href='#example2'>2、外包盒过滤，带高度范围</a><br>
<a href='#example3'>3、模型中心点过滤</a><br>
<a href='#example4'>4、模型中心点过滤，带高度范围</a><br>
<a href='#example5'>5、取消过滤</a><br>
<h5>支持如下方法：</h5>
<a href='#filterWithBoundingVolume'>[1、给定范围，如果模型的BoundingVolume和给定范围相交，则显示模型，否则不显示]</a><br/>
<a href='#filterWithCenter'>[2、给定范围，如果模型的中心点在给定范围内，则显示模型，否则不显示]</a><br/>
<a href='#removeFilter'>[3、撤销过滤]</a><br/>
<a href='#destroy'>[4、销毁工具]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='example1'>外包盒过滤</h7></p>
...
modelFilterTool.filterWithBoundingVolume(
  ...
  []
        ...
        <p class="code-caption"><h7 id='example2'>外包盒过滤，带高度范围</h7></p>
...
modelFilterTool.filterWithBoundingVolume(
  ...
  200
        ...
        <p class="code-caption"><h7 id='example3'>模型中心点过滤</h7></p>
...
modelFilterTool.filterWithCenter(
  ...
  []
        ...
        <p class="code-caption"><h7 id='example4'>模型中心点过滤，带高度范围</h7></p>
...
modelFilterTool.filterWithCenter(
  ...
  200
        ...
        <p class="code-caption"><h7 id='example5'>取消过滤</h7></p>
    
    
        <pre class="prettyprint"><code>modelFilterTool.removeFilter()</code></pre>
...
<dl class="details">
    ...
    <div class="description">
        <p>给定范围，如果模型的BoundingVolume和给定范围相交，则显示模型，否则不显示<a id='filterWithBoundingVolume'/></p>
    </div>
...
<span class="param-type">Array.&lt;Cesium.Cartesian3></span>
  ...
  <td class="description last"><p>给定过滤范围，默认经纬度高程坐标点数组，[Cesium.Cartesian3, Cesium.Cartesian3, Cesium.Cartesian3, ...]，<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/index.html?classFilter=Cartesian3' target='_blank'>详见Cesium.Cartesian3</a></p></td>
</tr>
...
<dl class="details">
    ...
    <div class="description">
        <p>给定范围，如果模型的中心点在给定范围内，则显示模型，否则不显示<a id='filterWithCenter'/></p>
    </div>
