...
<span class="param-type">undefined</span>
  ...
  <td class="description last"><p>模型对象，
...
<span class="param-type">Cesium.Cesium3DTileset</span>
  ...
  <td class="description last"><p>要控制的模型
详见<a href='http://webclient.smaryun.com/static/modules/cesium/api/cesium/MapGISM3DSet.html' target='_blank'>《Cesium.MapGISM3DSet》</a>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>请使用<a href="ModelTransformTool.html#setLocalScala"><code>ModelTransformTool#setLocalScala</code></a></li></ul></dd>
