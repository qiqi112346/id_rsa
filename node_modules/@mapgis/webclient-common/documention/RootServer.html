<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">RootServer</span>
...
<article>
    ...
    <h4 class="name" id="RootServer">
        <a class="href-link" href="#RootServer">#</a>
        
        <span class="code-name" id="RootServer" style="font-size:30px">
            
                new RootServer<span class="signature">(options)</span>
            ...
            <div class="table-container">
                <table class="params table">
                    ...
                    <tbody>
                            ...
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#queryFolderServiceList">queryFolderServiceList</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取指定文件夹下的服务列表</p></code></td>
                            </tr>
                        
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#queryRootServiceList">queryRootServiceList</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>查询根文件夹下的服务列表,后端接口为/igs/rest/services</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="queryFolderServiceList">
        <a class="href-link" href="#queryFolderServiceList">#</a>
        
        <span class="code-name" id="queryFolderServiceList" style="font-size:30px">
            
                queryFolderServiceList<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>文件夹名称,必填</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>服务名关键字</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>服务类型</p></td>
</tr>
...
rootServer.queryFolderServiceList({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="queryRootServiceList">
        <a class="href-link" href="#queryRootServiceList">#</a>
        
        <span class="code-name" id="queryRootServiceList" style="font-size:30px">
            
                queryRootServiceList<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>查询根文件夹下的服务列表,后端接口为/igs/rest/services</p>
    </div>
