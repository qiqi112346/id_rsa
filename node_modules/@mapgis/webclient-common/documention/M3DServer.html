<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">M3DServer</span>
...
<article>
    ...
    <h4 class="name" id="M3DServer">
        <a class="href-link" href="#M3DServer">#</a>
        
        <span class="code-name" id="M3DServer" style="font-size:30px">
            
                new M3DServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>M3d服务，服务地址:/igs/rest/services/{folder}/{serviceName}/M3dServer</p>
    </div>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取M3d公共服务资源,后端接口:/igs/rest/services/{serviceName}/M3dServer/sharedResources</p></code></td>
                            </tr>
                        
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#queryRootInfo">queryRootInfo</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取M3d节点信息,后端接口:/igs/rest/services/{serviceName}/M3dServer/nodes/{nodeId}</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取M3d根节点信息 后端接口：/igs/rest/services/{serviceName}/M3dServer/nodes/root</p></code></td>
                            </tr>
    ...
    <div class="description">
        <p>获取M3d公共服务资源,后端接口:/igs/rest/services/{serviceName}/M3dServer/sharedResources</p>
    </div>
...
m3dServer.getSharedResources({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="queryRootInfo">
        <a class="href-link" href="#queryRootInfo">#</a>
        
        <span class="code-name" id="queryRootInfo" style="font-size:30px">
            
                queryRootInfo<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取M3d节点信息,后端接口:/igs/rest/services/{serviceName}/M3dServer/nodes/{nodeId}</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>节点Id，必传</p></td>
</tr>
...
m3dServer.queryNodeInfo({
  ...
  console.log('请求失败：', result);
    ...
    <div class="description">
        <p>获取M3d根节点信息 后端接口：/igs/rest/services/{serviceName}/M3dServer/nodes/root</p>
    </div>
