<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">SketchCircleDrawTool</span>
...
<article>
    ...
    <h4 class="name" id="SketchCircleDrawTool">
        <a class="href-link" href="#SketchCircleDrawTool">#</a>
        
        <span class="code-name" id="SketchCircleDrawTool" style="font-size:30px">
            
                new SketchCircleDrawTool<span class="signature">(options)</span>
                ...
                <table class="params table">
                    ...
                    <tbody>
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>鼠标绘制图形：鼠标按下确定圆心，以左键拖动距离为半径生成圆，鼠标抬起确定圆</p></code></td>
                            </tr>
...
<dl class="details">
    ...
    <div class="description">
        <p>鼠标绘制图形：鼠标按下确定圆心，以左键拖动距离为半径生成圆，鼠标抬起确定圆</p>
    </div>
