<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">WMTSSubLayer</span>
...
<article>
    ...
    <h4 class="name" id="WMTSSubLayer">
        <a class="href-link" href="#WMTSSubLayer">#</a>
        
        <span class="code-name" id="WMTSSubLayer" style="font-size:30px">
            
                new WMTSSubLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>描述信息</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>图像格式</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>图像格式组</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>样式id</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>样式组</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>要请求的图块矩阵集</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>要请求的图块矩阵集id</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>资源地址模板</p></td>
</tr>
...
<span class="param-type">
             ...
             <a link="Extent.html" onclick="getTypeHTML(event)" href="Extent.html">Extent</a>
                                ...
                                <td class="name"><code><p>图层范围</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="SpatialReference.html" onclick="getTypeHTML(event)" href="SpatialReference.html">SpatialReference</a>
                                ...
                                <td class="name"><code><p>图层坐标系</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Array.&lt;<a onclick="getTypeHTML(event)" link="WMTSStyle.html">WMTSStyle</a>>
                                ...
                                <td class="name"><code><p>样式组</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="TileMatrixSet.html" onclick="getTypeHTML(event)" href="TileMatrixSet.html">TileMatrixSet</a>
                                ...
                                <td class="name"><code><p>要请求的图块矩阵集</p></code></td>
                            </tr>
...
<h4 class="name" id="imageFormats">
    <a class="href-link" href="#imageFormats">#</a>
...
<h4 class="name" id="resourceURLTemplates">
    <a class="href-link" href="#resourceURLTemplates">#</a>
...
<h4 class="name" id="styleId">
    <a class="href-link" href="#styleId">#</a>
...
<h4 class="name" id="tileMatrixSet">
    <a class="href-link" href="#tileMatrixSet">#</a>
...
<h4 class="name" id="tileMatrixSetId">
    <a class="href-link" href="#tileMatrixSetId">#</a>
...
<h4 class="name" id="tileMatrixSets">
    <a class="href-link" href="#tileMatrixSets">#</a>
...
<span class="param-type">
             ...
             *
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>将JSON格式的子图层参数转换为JS对象</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Object
                                ...
                                <td class="name"><code><p>将JS对象转换为JSON格式</p></code></td>
                            </tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>子图层的实例化JSON</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>子图层的实例化JSON</p></div>
