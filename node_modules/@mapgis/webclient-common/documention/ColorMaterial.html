<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">ColorMaterial</span>
...
<article>
    ...
    <h4 class="name" id="ColorMaterial">
        <a class="href-link" href="#ColorMaterial">#</a>
        
        <span class="code-name" id="ColorMaterial" style="font-size:30px">
            
                new ColorMaterial<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>材质颜色</p></td>
</tr>
...
<a href='#fromJSON'>[1、通过json数据构造一个ColorMaterial对象]</a><br/>
<a href='#toJSON'>[2、导出为json数据]</a><br/>
<a href='#clone'>[3、克隆并返回一个新的ColorMaterial对象]</a><br/></p>
...
<span class="param-type">
             ...
             <a link="Color.html" onclick="getTypeHTML(event)" href="Color.html">Color</a>
                                ...
                                <td class="name"><code><p>材质颜色</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             String
                                ...
                                <td class="name"><code><p>材质类型</p></code></td>
                            </tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的ColorMaterial对象</p></div>
