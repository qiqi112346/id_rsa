<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">MultiPolygon</span>
...
<article>
    ...
    <h4 class="name" id="MultiPolygon">
        <a class="href-link" href="#MultiPolygon">#</a>
        
        <span class="code-name" id="MultiPolygon" style="font-size:30px">
            
                new MultiPolygon<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>几何点的坐标数组，参考示例：<a href='#MultiPolygon'>[多区几何对象]</a></p></td>
</tr>
...
<a href="Geometry.html#clone"><code>10、克隆几何对象</code></a></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='MultiPolygon'>创建几何对象</h7></p>
...
<span class="param-type">
             ...
             <a link="MultiPolygon.html" onclick="getTypeHTML(event)" href="MultiPolygon.html">MultiPolygon</a>
                                ...
                                <td class="name"><code><p>在多区末尾添加区</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             null
                                ...
                                <td class="name"><code><p>根据区几何的下标删除的区对象</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Array.&lt;<a onclick="getTypeHTML(event)" link="Polygon.html">Polygon</a>>
                                ...
                                <td class="name"><code><p>多区对象转区对象数组</p></code></td>
                            </tr>
...
const multiPolygon = new MultiPolygon.fromJSON(json)</code></pre>
    ...
    <h4 class="name" id="addPolygon">
        <a class="href-link" href="#addPolygon">#</a>
        
        <span class="code-name" id="addPolygon" style="font-size:30px">
            
                addPolygon<span class="signature">(polygon, mode<span class="signature-attributes">opt</span>)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>要添加区几何对象</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>添加模式，add:正常添加，deduplication:去除重复点，即当新加的区几何和现有的一个或多个几何相交时，会合并几何对象</p></td>
</tr>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='addPolygon'>在多区末尾添加区</h7></p>
...
multiPolygon.addPolygon(polygon)</code></pre>
...
const isIn = multiPolygon.contains(point)</code></pre>
...
view.on({
  ...
  "right-click-down": clickFunction
    ...
    <h4 class="name" id="removePolygon">
        <a class="href-link" href="#removePolygon">#</a>
        
        <span class="code-name" id="removePolygon" style="font-size:30px">
            
                removePolygon<span class="signature">(polygonIndex)</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回删除的区对象</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='removePolygon'>根据区几何的下标删除的区对象</h7></p>
...
multiPolygon.removePolygon(0)</code></pre>
...
<div class="columns">
    ...
    <h4 class="name" id="toPolygonArray">
        <a class="href-link" href="#toPolygonArray">#</a>
        
        <span class="code-name" id="toPolygonArray" style="font-size:30px">
            
                toPolygonArray<span class="signature">()</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>区对象数组</p></div>
...
<span class="param-type">
    ...
    <div class="description">
        <p>返回如下格式的字符串：&quot;x0,y0,x1,y1,x2,y2,x0,y0|x3,y3,x4,y4,x5,y5,x3,y3;x6,y6,x7,y7,x8,y8,x6,y6|x9,y9,x10,y10,x11,y11,x9,y9&quot;<a id='toString'></a>
多边形内每个的多边形由|号分割，多个多边形由;号分割</p>
    </div>
...
<div class="columns">
    ...
    <div class="description">
        <p>导出为OGC服务要求的xml字符串<a id='toXMl'></a></p>
    </div>
