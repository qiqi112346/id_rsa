<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">SceneLayer</span>
...
<article>
    ...
    <h4 class="name" id="SceneLayer">
        <a class="href-link" href="#SceneLayer">#</a>
        
        <span class="code-name" id="SceneLayer" style="font-size:30px">
            
                new SceneLayer<span class="signature">(options)</span>
