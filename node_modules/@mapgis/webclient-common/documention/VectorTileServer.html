<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">VectorTileServer</span>
...
<article>
    ...
    <h4 class="name" id="VectorTileServer">
        <a class="href-link" href="#VectorTileServer">#</a>
        
        <span class="code-name" id="VectorTileServer" style="font-size:30px">
            
                new VectorTileServer<span class="signature">(options)</span>
...
BaseServer.url = '新URL';</code></pre>
                ...
                <table class="params table">
                    ...
                    <tbody>
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>获取矢量瓦片字体</p></code></td>
                            </tr>
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>获取矢量瓦片sprite图</p></code></td>
                            </tr>
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>获取矢量瓦片样式</p></code></td>
                            </tr>
                            ...
                            <tr class="deep-level-0">
                                ...
                                <td class="name"><code><p>获取服务信息</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="getFonts">
        <a class="href-link" href="#getFonts">#</a>
        
        <span class="code-name" id="getFonts" style="font-size:30px">
            
                getFonts<span class="signature">(options)</span>
...
vectorTileServer.queryServerInfo().then(function (result) {
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getSprite">
        <a class="href-link" href="#getSprite">#</a>
        
        <span class="code-name" id="getSprite" style="font-size:30px">
            
                getSprite<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>sprite图格式,支持后缀为.json或.png</p></td>
</tr>
...
vectorTileServer.getSprite().then(function (result) {
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getStyle">
        <a class="href-link" href="#getStyle">#</a>
        
        <span class="code-name" id="getStyle" style="font-size:30px">
            
                getStyle<span class="signature">(options)</span>
