<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">WorkFlowServer</span>
...
<article>
    ...
    <h4 class="name" id="WorkFlowServer">
        <a class="href-link" href="#WorkFlowServer">#</a>
        
        <span class="code-name" id="WorkFlowServer" style="font-size:30px">
            
                new WorkFlowServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>工作流服务,基地址http://{ip}:{port}/igs/rest/services/workflow/{serviceName}/WorkflowServer</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>服务基地址，必传</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>// 以下以“根据参照系名称进行投影转换”工作流举例,其他工作流用法请参考前文中“不同工作流参数配置”
...
<span class="param-type">
             ...
             <a link="WorkFlowServer.html" onclick="getTypeHTML(event)" href="WorkFlowServer.html">WorkFlowServer</a>
                                ...
                                <td class="name"><code><p>根据工作流id创建工作流</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <h4 class="name" id=".createWorkFlow">
        <a class="href-link" href="#.createWorkFlow">#</a>
        
            
                <span class='tag'>static</span>
            
        
        <span class="code-name" id="createWorkFlow" style="font-size:30px">
            
                createWorkFlow<span class="signature">(工作流参数)</span>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const workflow = WorkFlowServer.createWorkFlow({
  url: "http://localhost:8089/igs/rest/services/workflow/600235/WorkflowServer",
   clsName: "gdbp://MapGISLocalPlus/test/sfcls/湖泊",
   desClsName: `gdbp://MapGISLocalPlus/test/sfcls/湖泊${Math.random()}`,
  crsName: "高斯大地坐标系_西安80_36带3_北",
