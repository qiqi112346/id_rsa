<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">LineString</span>
...
<article>
    ...
    <h4 class="name" id="LineString">
        <a class="href-link" href="#LineString">#</a>
        
        <span class="code-name" id="LineString" style="font-size:30px">
            
                new LineString<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>几何点的坐标数组，支持任意单位，参考示例：<a href='#LineString'>[线几何对象]</a></p></td>
</tr>
...
<a href="Geometry.html#clone"><code>12、克隆几何对象</code></a></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h5 id='LineString'>创建几何对象</h5></p>
...
<span class="param-type">
             ...
             null
                                ...
                                <td class="name"><code><p>获取线上点</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="LineString.html" onclick="getTypeHTML(event)" href="LineString.html">LineString</a>
                                ...
                                <td class="name"><code><p>插入点到线上</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="Point.html" onclick="getTypeHTML(event)" href="Point.html">Point</a>
                                ...
                                <td class="name"><code><p>删除线上点</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="LineString.html" onclick="getTypeHTML(event)" href="LineString.html">LineString</a>
                                ...
                                <td class="name"><code><p>修改线上点</p></code></td>
                            </tr>
...
const line = LineString.fromJSON(json)</code></pre>
...
<div class="columns">
    ...
    <h4 class="name" id="getPoint">
        ...
        <span class="code-name" id="getPoint" style="font-size:30px">
                ...
                getPoint<span class="signature">(pointIndex)</span>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='getPoint'>获取线上点</h7></p>
...
const point = lineString.getPoint(0)</code></pre>
...
<span class="param-type">
    ...
    <h4 class="name" id="insertPoint">
        ...
        <span class="code-name" id="insertPoint" style="font-size:30px">
                ...
                insertPoint<span class="signature">(pointIndex, point)</span>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='insertPoint'>插入点到线上</h7></p>
...
lineString.insertPoint(1, [102.0, 2.0])</code></pre>
  ...
  "right-click-down": clickFunction
    ...
    <h4 class="name" id="removePoint">
        ...
        <span class="code-name" id="removePoint" style="font-size:30px">
                ...
                removePoint<span class="signature">(pointIndex)</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>删除点</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='removePoint'>删除线上点</h7></p>
...
lineString.removePoint(0)</code></pre>
    ...
    <h4 class="name" id="setPoint">
        ...
        <span class="code-name" id="setPoint" style="font-size:30px">
                ...
                setPoint<span class="signature">(pointIndex, point)</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>修改后的线对象</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='setPoint'>修改线上点</h7></p>
...
lineString.setPoint(0, [11.0, 1.2])</code></pre>
