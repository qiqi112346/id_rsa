<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">Layer</span>
...
<article>
    ...
    <h4 class="name" id="Layer">
        ...
        <span class="code-name" id="Layer" style="font-size:30px">
            
                new Layer<span class="signature">(options)</span>
...
<span class="param-type">
         ...
         Promise.&lt;<a onclick="getTypeHTML(event)" link="Layer.html">Layer</a>>
                                ...
                                <td class="name"><code><p>根据服务url加载图层(通过判断url链接获取图层,等图层全部封装完毕后处理此函数)</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;<a onclick="getTypeHTML(event)" link="Layer.html">Layer</a>>
                                ...
                                <td class="name"><code><p>图层资源加载</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <h4 class="name" id=".fromServerUrl">
        ...
        <span class="code-name" id="fromServerUrl" style="font-size:30px">
                ...
                fromServerUrl<span class="signature">(url, options)</span>
    ...
    <div class="description">
        <p>根据服务url加载图层(通过判断url链接获取图层,等图层全部封装完毕后处理此函数)</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>图层配置</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>从url中加载图层</p></div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>资源加载完毕的图层</p></div>
