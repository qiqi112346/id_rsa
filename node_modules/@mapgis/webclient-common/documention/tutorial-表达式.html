<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">表达式</span>
...
<h4>链接符</h4>
<p>目前仅支持$feature链接符，支持访问要素的属性信息。
<strong>example</strong></p>
<pre class="prettyprint source"><code>$feature.FID //表示访问要素的FID字段
</code></pre>
<h4><strong>数学运算</strong></h4>
<p>支持一般通用数学运算符，如+-*/等计算符</p>
<p><strong>example</strong></p>
<p>计算面积占比</p>
<pre class="prettyprint source"><code>$feature.AREA/$feature.TOTALAREA
</code></pre>
