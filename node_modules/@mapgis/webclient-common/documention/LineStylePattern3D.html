<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">LineStylePattern3D</span>
...
<article>
    ...
    <h4 class="name" id="LineStylePattern3D">
        <a class="href-link" href="#LineStylePattern3D">#</a>
        
        <span class="code-name" id="LineStylePattern3D" style="font-size:30px">
            
                new LineStylePattern3D<span class="signature">(options)</span>
...
<a href='#clone'>[3、克隆并返回一个新的LineStylePattern3D对象]</a><br/></p>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的LineStylePattern3D对象</p></div>
