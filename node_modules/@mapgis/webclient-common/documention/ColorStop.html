<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">ColorStop</span>
...
<article>
    ...
    <h4 class="name" id="ColorStop">
        <a class="href-link" href="#ColorStop">#</a>
        
        <span class="code-name" id="ColorStop" style="font-size:30px">
            
                new ColorStop<span class="signature">(options)</span>
...
<span class="param-type">
             ...
             <a link="ColorStop.html" onclick="getTypeHTML(event)" href="ColorStop.html">ColorStop</a>
                                ...
                                <td class="name"><code><p>通过json构造ColorStop对象</p></code></td>
                            </tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>克隆后的ColorStop对象</p></div>
