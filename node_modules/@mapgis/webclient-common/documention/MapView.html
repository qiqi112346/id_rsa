...
<article>
    ...
    <h4 class="name" id="MapView">
        ...
        <span class="code-name" id="MapView" style="font-size:30px">
...
<span class="param-type">
  ...
  <td class="description last"><p>相邻级别分辨率的比值。默认为1.05。小于此值则会将两个级别合并为一个级别显示。以1.414和1.2分辨率举例，1.414/1.2=1.17833, 1.17833大于1.05保留1.2分辨率对应的层级。1.414/1.4=1.01, 1.01小于1.05, 会将1.414和1.4分辨率对应的层级合并为一级。</p></td>
</tr>
...
<h4 class="name" id="mergeLevelRatio">
    <a class="href-link" href="#mergeLevelRatio">#</a>
...
<div class="description">
    <p>相邻级别分辨率的比值。默认为1.05。小于此值则会将两个级别合并为一个级别显示。以1.414和1.2分辨率举例，1.414/1.2=1.17833, 1.17833大于1.05保留1.2分辨率对应的层级。1.414/1.4=1.01, 1.01小于1.05, 会将1.414和1.4分辨率对应的层级合并为一级。</p>
</div>
