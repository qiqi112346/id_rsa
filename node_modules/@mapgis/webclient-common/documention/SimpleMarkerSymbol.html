<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">SimpleMarkerSymbol</span>
...
<article>
    ...
    <h4 class="name" id="SimpleMarkerSymbol">
        <a class="href-link" href="#SimpleMarkerSymbol">#</a>
        
        <span class="code-name" id="SimpleMarkerSymbol" style="font-size:30px">
            
                new SimpleMarkerSymbol<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>填充颜色，默认为白色</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>外边线样式</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>像素块大小(半径)，单位像素</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>marker样式,默认'circle',可选&quot;circle&quot;|&quot;square&quot;|&quot;cross&quot;|&quot;x&quot;|&quot;diamond&quot;|&quot;triangle&quot;</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>svg中path标签的d属性，用于自定义，优先级高于style，不支持过于复杂的d属性，不支持SceneView</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>marker的x轴偏移，单位像素</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>marker的y轴偏移，单位像素</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>Marker图标的旋转角度，单位度，0~360度，顺时针旋转</p></td>
</tr>
...
<a href='#fromJSON'>[3、通过json构造并返回一个新的SimpleMarkerSymbol对象]</a></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='new-SimpleMarkerSymbol'>简单Marker样式</h7></p>
...
const simpleMarkerSymbol = new SimpleMarkerSymbol({
  ...
  outline: new SimpleLineSymbol({
    ...
    width: 2
        ...
        <p class="code-caption"><h7 id='new-SimpleMarkerSymbol'>符号style和自定义path路径说明</h7></p>
    
    
        <pre class="prettyprint"><code>// 不论是style还是path，都是描述了图形的形状。值得注意的是，图形的填充颜色由color决定，图形的线划参数由outline属性决定。
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>旋转角度</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="SimpleLineSymbol.html" onclick="getTypeHTML(event)" href="SimpleLineSymbol.html">SimpleLineSymbol</a>
                                ...
                                <td class="name"><code><p>外边线样式类型</p></code></td>
                            </tr>
                        
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#path">path</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
             ...
             String
                                ...
                                <td class="name"><code><p>svg中path标签的d属性，用于自定义，优先级高于style，不支持过于复杂的d属性，不支持SceneView</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>marker大小</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>marker的x轴偏移</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>marker的y轴偏移</p></code></td>
                            </tr>
...
<h4 class="name" id="outline">
    <a class="href-link" href="#outline">#</a>
...
<div class="description">
    <p>svg中path标签的d属性，用于自定义，优先级高于style，不支持过于复杂的d属性，不支持SceneView</p>
</div>
...
<span class="param-type">
             ...
             <a link="SimpleMarkerSymbol.html" onclick="getTypeHTML(event)" href="SimpleMarkerSymbol.html">SimpleMarkerSymbol</a>
                                ...
                                <td class="name"><code><p>通过json构造并返回一个新的SimpleMarkerSymbol对象</code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="SimpleMarkerSymbol.html" onclick="getTypeHTML(event)" href="SimpleMarkerSymbol.html">SimpleMarkerSymbol</a>
                                ...
                                <td class="name"><code><p>克隆并返回新的符号对象</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <div class="description">
        <p>通过json构造并返回一个新的SimpleMarkerSymbol对象<a id='fromJSON'></a></p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>符号的实例化JSON</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的SimpleMarkerSymbol对象</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>&lt;caption>&lt;h7>通过json构造并返回一个新的SimpleMarkerSymbol对象&lt;/h7>&lt;/caption></code></pre>
