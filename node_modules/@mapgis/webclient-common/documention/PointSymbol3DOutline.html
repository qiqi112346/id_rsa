<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">PointSymbol3DOutline</span>
...
<article>
    ...
    <h4 class="name" id="PointSymbol3DOutline">
        <a class="href-link" href="#PointSymbol3DOutline">#</a>
        
        <span class="code-name" id="PointSymbol3DOutline" style="font-size:30px">
            
                new PointSymbol3DOutline<span class="signature">(options)</span>
...
<a href='#fromJSON'>[1、通过json数据构造一个PointSymbol3DOutline对象]</a><br/>
<a href='#toJSON'>[2、导出为json数据]</a><br/>
<a href='#clone'>[3、克隆并返回一个新的PointSymbol3DOutline对象]</a><br/></p>
...
<span class="param-type">
             ...
             <a link="Color.html" onclick="getTypeHTML(event)" href="Color.html">Color</a>
                                ...
                                <td class="name"><code><p>外边线颜色</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>外边线宽度</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <div class="description">
        <a id='fromJSON'/>
通过json数据构造一个PointSymbol3DOutline对象
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的PointSymbol3DOutline对象</p></div>
...
<span class="param-type">
    ...
    <div class="description">
        <a id='clone'/>
克隆并返回一个新的PointSymbol3DOutline对象
    </div>
