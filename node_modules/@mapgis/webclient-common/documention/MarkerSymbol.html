<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">MarkerSymbol</span>
...
<article>
    ...
    <h4 class="name" id="MarkerSymbol">
        <a class="href-link" href="#MarkerSymbol">#</a>
        
        <span class="code-name" id="MarkerSymbol" style="font-size:30px">
            
                new MarkerSymbol<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>旋转角度，单位度，0~360度</p></td>
</tr>
...
<span class="param-type">
             ...
             <a link="MarkerSymbol.html" onclick="getTypeHTML(event)" href="MarkerSymbol.html">MarkerSymbol</a>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>符号的实例化JSON</p></div>
