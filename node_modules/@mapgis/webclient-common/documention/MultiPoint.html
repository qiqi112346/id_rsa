<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">MultiPoint</span>
...
<article>
    ...
    <h4 class="name" id="MultiPoint">
        <a class="href-link" href="#MultiPoint">#</a>
        
        <span class="code-name" id="MultiPoint" style="font-size:30px">
            
                new MultiPoint<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>几何点的坐标，支持任意单位，参考示例：<a href='#MultiPoint'>[多点几何对象]</a></p></td>
</tr>
...
<a href="Geometry.html#clone"><code>11、克隆几何对象</code></a></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h5 id='MultiPoint'>创建几何对象</h5></p>
...
new MultiPoint({
  coordinates:[
    ...
    [101, 1.0]
        ...
        <p class="code-caption"><h5 id='SpatialReference'>指定坐标系</h5></p>
...
<span class="param-type">
             ...
             <a link="MultiPoint.html" onclick="getTypeHTML(event)" href="MultiPoint.html">MultiPoint</a>
                                ...
                                <td class="name"><code><p>添加点坐标，可以为Point对象、[x, y, z(可选)]数组、Point对象数组、[x, y, z(可选)]对象数组</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Boolean
                                ...
                                <td class="name"><code><p>判断多点对象是否包含某一个点</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="Point.html" onclick="getTypeHTML(event)" href="Point.html">Point</a>
                                ...
                                <td class="name"><code><p>返回指定索引处的点</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             null
                                ...
                                <td class="name"><code><p>从多点中移除一个点。索引指定要删除的点</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="MultiPoint.html" onclick="getTypeHTML(event)" href="MultiPoint.html">MultiPoint</a>
                                ...
                                <td class="name"><code><p>更新指定索引处的点</p></code></td>
                            </tr>
...
const multiPoint = MultiPoint.fromJSON(json)</code></pre>
    ...
    <h4 class="name" id="addPoint">
        <a class="href-link" href="#addPoint">#</a>
        
        <span class="code-name" id="addPoint" style="font-size:30px">
            
                addPoint<span class="signature">(point, mode<span class="signature-attributes">opt</span>)</span>
    ...
    <div class="description">
        <p>添加点坐标，可以为Point对象、[x, y, z(可选)]数组、Point对象数组、[x, y, z(可选)]对象数组</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>可以是point，也可以是表示XY坐标的数字数组</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>添加模式，add:正常添加，deduplication:去除重复点</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>多点对象</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='addPoint'>添加点坐标</h7></p>
...
multiPoint.addPoint([102,2.0])</code></pre>
...
<span class="param-type">
  ...
  <td class="description last"><p>点对象</p></td>
</tr>
...
<div class="columns">
    ...
    <h4 class="name" id="getPoint">
        ...
        <span class="code-name" id="getPoint" style="font-size:30px">
                ...
                getPoint<span class="signature">(index)</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>在指定下标处的点</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='getPoint'>返回指定索引处的点</h7></p>
...
const point = multiPoint.getPoint(0)</code></pre>
  ...
  "right-click-down": clickFunction
    ...
    <h4 class="name" id="removePoint">
        ...
        <span class="code-name" id="removePoint" style="font-size:30px">
                ...
                removePoint<span class="signature">(index)</span>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回被移除的点</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='removePoint'>从多点中移除一个点</h7></p>
...
const point = multiPoint.removePoint(0)</code></pre>
    ...
    <h4 class="name" id="setPoint">
        ...
        <span class="code-name" id="setPoint" style="font-size:30px">
                ...
                setPoint<span class="signature">(index, point)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>点在points属性中的索引</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>在新位置指定的几何点</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>返回更新后的多点</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='setPoint'>更新指定索引处的点</h7></p>
...
multiPoint.setPoint(1, [103, 3.0])</code></pre>
    ...
    <h4 class="name" id="toDots">
        <a class="href-link" href="#toDots">#</a>
        
        <span class="code-name" id="toDots" style="font-size:30px">
            
                toDots<span class="signature">()</span>
    ...
    <div class="description">
        <p>返回Dots对象，仅包括多边形的外圈<a id='toDots'></a></p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>Array Dots对象</p></div>
...
<span class="param-type">
    ...
    <h4 class="name" id="toOldIGSGeometry">
        <a class="href-link" href="#toOldIGSGeometry">#</a>
        
        <span class="code-name" id="toOldIGSGeometry" style="font-size:30px">
            
                toOldIGSGeometry<span class="signature">()</span>
    ...
    <div class="description">
        <p>返回igs1.0的几何对象<a id='toOldIGSGeometry'></a></p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>Object igs1.0的几何对象</p></div>
    ...
    <div class="description">
        <p>返回如下格式的字符串：&quot;x0,y0,x1,y1,x2,y2&quot;<a id='toString'></a></p>
    </div>
