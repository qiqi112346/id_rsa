...
<article>
    ...
    <h4 class="name" id="FeatureLayer">
        ...
        <span class="code-name" id="FeatureLayer" style="font-size:30px">
                ...
                new FeatureLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>要素集合</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>渲染样式</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>三维描述信息，暂时不支持</p></td>
</tr>
