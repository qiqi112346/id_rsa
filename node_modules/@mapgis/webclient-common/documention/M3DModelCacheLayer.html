<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">M3DModelCacheLayer</span>
...
<article>
    ...
    <h4 class="name" id="M3DModelCacheLayer">
        <a class="href-link" href="#M3DModelCacheLayer">#</a>
        
        <span class="code-name" id="M3DModelCacheLayer" style="font-size:30px">
            
                new M3DModelCacheLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>服务基地址，支持文件服务和IGS的M3D服务<br/>
文件服务基地址格式：必须是.mcj格式的文件<br/>
M3D服务基地址格式(IGS1.0)：无此服务<br/>
M3D服务基地址格式(IGS2.0)：http://{ip}:{port}/igs/rest/services/{服务名}/M3dServer</p></td>
</tr>
...
<a href='#UniqueValueRenderer-Cesium'>[3、单值专题图-Cesium原生方式]</a><br/>
<a href='#ClassBreakRenderer-Cesium'>[4、分段专题图-Cesium原生方式]</a><br/></p></td>
</tr>
...
<a href='#clone'>[4、克隆图层对象]</a><br/>
<a href='#fromServerUrl'>[5、通过url构造图层对象]</a><br/></p>



    <h5>示例</h5>
    
        <p class="code-caption"><h7 id='M3DModelCacheLayer'>初始化模型缓存图层</h7></p>
...
<dl class="details">
    ...
    <h4 class="name" id=".fromServerUrl">
        <a class="href-link" href="#.fromServerUrl">#</a>
        
            
                <span class='tag'>static</span>
            
        
        <span class="code-name" id="fromServerUrl" style="font-size:30px">
            
                fromServerUrl<span class="signature">(url)</span>
