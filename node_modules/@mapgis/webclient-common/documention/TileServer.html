<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">TileServer</span>
...
<article>
    ...
    <h4 class="name" id="TileServer">
        <a class="href-link" href="#TileServer">#</a>
        
        <span class="code-name" id="TileServer" style="font-size:30px">
            
                new TileServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>瓦片服务,基地址：/igs/rest/services/{folder}/{serviceName}/TileServer</p>
    </div>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>//初始化TileServer服务对象
// ES5引入方式
