<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">WorkFlowServer600336</span>
...
<article>
    ...
    <h4 class="name" id="WorkFlowServer600336">
        <a class="href-link" href="#WorkFlowServer600336">#</a>
        
        <span class="code-name" id="WorkFlowServer600336" style="font-size:30px">
            
                new WorkFlowServer600336<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>网络类的URL,必传,例如:gdbp://MapGisLocal/sample/ds/网络分析/ncls/道路交通网</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>是否进行网标操作,必传,例如:{&quot;activeValue&quot;:true,&quot;inactiveValue&quot;:false}</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>网标点坐标字符串,逗号分隔,形如：x1,y1,x2,y2,必传,例如:114.44,38.06,114.56,38.03</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>添加网标方式,逗号分隔,必传,例如:1,2</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>容差,必传,例如:0.01</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const workFlowServer600336 = WorkFlowServer.createWorkFlow({
...
<div class="description">
    <p>是否进行网标操作,必传,例如:{&quot;activeValue&quot;:true,&quot;inactiveValue&quot;:false}</p>
</div>
...
<h4 class="name" id="flagPosStr">
    <a class="href-link" href="#flagPosStr">#</a>
...
<div class="description">
    <p>网标点坐标字符串,逗号分隔,形如：x1,y1,x2,y2,必传,例如:114.44,38.06,114.56,38.03</p>
</div>
...
<div class="description">
    <p>网络类的URL,必传,例如:gdbp://MapGisLocal/sample/ds/网络分析/ncls/道路交通网</p>
</div>
