<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">OpacityStop</span>
...
<article>
    ...
    <h4 class="name" id="OpacityStop">
        <a class="href-link" href="#OpacityStop">#</a>
        
        <span class="code-name" id="OpacityStop" style="font-size:30px">
            
                new OpacityStop<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>数值</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>视觉变量分段描述</p></td>
</tr>
...
<span class="param-type">
             ...
             String
                                ...
                                <td class="name"><code><p>视觉变量分段描述</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>透明度</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             Number
                                ...
                                <td class="name"><code><p>数值</p></code></td>
                            </tr>
...
<span class="param-type">
             ...
             <a link="OpacityStop.html" onclick="getTypeHTML(event)" href="OpacityStop.html">OpacityStop</a>
                                ...
                                <td class="name"><code><p>通过json构造OpacityStop对象</p></code></td>
                            </tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>克隆后的OpacityStop对象</p></div>
