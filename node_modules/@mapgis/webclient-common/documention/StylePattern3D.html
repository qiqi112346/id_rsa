<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">StylePattern3D</span>
...
<article>
    ...
    <h4 class="name" id="StylePattern3D">
        <a class="href-link" href="#StylePattern3D">#</a>
        
        <span class="code-name" id="StylePattern3D" style="font-size:30px">
            
                new StylePattern3D<span class="signature">(options)</span>
...
<span class="param-type">
      ...
      <td class="default">
          ...
          LinePatternStyle.solid
      
      </td>
  

  <td class="description last"><p>虚线样式</p></td>
</tr>
...
<a href='#fromJSON'>[1、通过json数据构造一个StylePattern3D对象]</a><br/>
<a href='#toJSON'>[2、导出为json数据]</a><br/>
<a href='#clone'>[3、克隆并返回一个新的StylePattern3D对象]</a><br/></p>
...
<span class="param-type">
             ...
             <a link="LinePatternStyle.html" onclick="getTypeHTML(event)" href="global.html#LinePatternStyle">LinePatternStyle</a>
                                ...
                                <td class="name"><code><p>虚线样式</p></code></td>
                            </tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的StylePattern3D对象</p></div>
