<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">ArcGISTileLayer</span>
...
<article>
    ...
    <h4 class="name" id="ArcGISTileLayer">
        <a class="href-link" href="#ArcGISTileLayer">#</a>
        
        <span class="code-name" id="ArcGISTileLayer" style="font-size:30px">
            
                new ArcGISTileLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>服务基地址：https://{ip}:{port}/arcgis/rest/services/{serviceName}/MapServer，<br/>
...
<span class="param-type">
  ...
  <td class="description last"><p>图层坐标系，默认从服务元信息上读取</p></td>
</tr>
...
<a href="OGCLayer.html#clone"><code>6、克隆几何对象</code></a></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='ArcGISTileLayer'>ArcGIS的瓦片图层示例</h7></p>
...
arcgisTileLayer.on('layerview-created', function (result) {
  ...
  arcgisTileLayer.visible = !arcgisTileLayer.visible
        ...
        <pre class="prettyprint"><code>map.remove(arcgisTileLayer)</code></pre>
...
map.reorder(arcgisTileLayer, '要移动到的index');</code></pre>
...
<span class="param-type">
             ...
             String
                                ...
                                <td class="name"><code><p>根据级数以及行列号获取瓦片的url</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <div class="description">
        <p>通过传入的json构造并返回一个新的ArcGISTileLayer对象<a id='fromJSON'></a></p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的ArcGISTileLayer对象</p></div>
...
const arcgisTileLayer = new ArcGISTileLayer.fromJSON(json)</code></pre>
...
<span class="param-type">
    ...
    <h4 class="name" id="getTileUrl">
        <a class="href-link" href="#getTileUrl">#</a>
        
        <span class="code-name" id="getTileUrl" style="font-size:30px">
            
                getTileUrl<span class="signature">(level, row, col)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>瓦片级数</p></td>
</tr>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>瓦片请求地址</p></div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='getTileUrl'>根据级数以及行列号获取瓦片的url</h7></p>
    
    
        <pre class="prettyprint"><code>const url = arcgisTileLayer.getTileUrl(0, 1, 2)</code></pre>
