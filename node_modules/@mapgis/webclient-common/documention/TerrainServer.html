<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">TerrainServer</span>
...
<article>
    ...
    <h4 class="name" id="TerrainServer">
        <a class="href-link" href="#TerrainServer">#</a>
        
        <span class="code-name" id="TerrainServer" style="font-size:30px">
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取地形缓存layer.json,后端接口：/igs/rest/services/{serviceName}/TerrainServer/layer.json</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="getLayerJSON">
        <a class="href-link" href="#getLayerJSON">#</a>
        
        <span class="code-name" id="getLayerJSON" style="font-size:30px">
            
                getLayerJSON<span class="signature">(options)</span>
