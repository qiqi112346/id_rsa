...
<article>
    ...
    <h4 class="name" id="IGSTileLayer">
        ...
        <span class="code-name" id="IGSTileLayer" style="font-size:30px">
                ...
                new IGSTileLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>图层坐标系，默认从服务元信息上读取，当为igs1.0服务时，需要用户指定坐标系，
参考示例：<a href='#igs-1'>[设置图层坐标系(IGS1.0)]</a></p></td>
</tr>
...
<a href="OGCLayer.html#clone"><code>6、克隆几何对象</code></a></p>
    ...
    <h5>示例</h5>
        ...
        <p class="code-caption"><h7 id='igs-1'>IGS1.0的瓦片图层示例</h7></p>
...
const igsTileLayer = new IGSTileLayer({
  ...
  spatialReference: new SpatialReference({
    wkid: 4326
        ...
        <p class="code-caption"><h7 id='igs-2'>IGS2.0的瓦片图层示例</h7></p>
...
arcgisTileLayer.on('layerview-created', function (result) {
  ...
  igsTileLayer.visible = !igsTileLayer.visible
        ...
        <p class="code-caption"><h7>ArcGIS的瓦片图层示例</h7></p>
...
const arcgisTileLayer = new IGSTileLayer({
  url: 'https://services.arcgisonline.com/arcgis/rest/services/World_Terrain_Base/MapServer'
        ...
        <pre class="prettyprint"><code>map.remove(igsTileLayer)</code></pre>
...
map.reorder(igsTileLayer, '要移动到的index');</code></pre>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const url = igsTileLayer.getTileUrl(0, 1, 2)</code></pre>
