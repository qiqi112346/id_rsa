...
<article>
    ...
    <h4 class="name" id="TileLayer">
        ...
        <span class="code-name" id="TileLayer" style="font-size:30px">
                ...
                new TileLayer<span class="signature">(options)</span>
...
<span class="param-type">
             ...
             <a link="TileSliceType.html" onclick="getTypeHTML(event)" href="global.html#TileSliceType">TileSliceType</a>
                                ...
                                <td class="name"><code><p>瓦片的切片方式。支持TMS和WMTS两种切片方式的瓦片加载，默认为wmts切片方式</p></code></td>
                            </tr>
...
<div class="description">
    <p>瓦片的切片方式。支持TMS和WMTS两种切片方式的瓦片加载，默认为wmts切片方式</p>
</div>
