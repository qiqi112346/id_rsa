<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">Cesium3DTilesServer</span>
...
<article>
    ...
    <h4 class="name" id="Cesium3DTilesServer">
        <a class="href-link" href="#Cesium3DTilesServer">#</a>
        
        <span class="code-name" id="Cesium3DTilesServer" style="font-size:30px">
            
                new Cesium3DTilesServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>3DTiles服务，基地址：/igs/rest/services/{folder}/{serviceName}/3DTilesServer</p>
    </div>
            ...
            <div class="table-container">
                <table class="params table">
                    ...
                    <tbody>
                            ...
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#getTileSetJSON">getTileSetJSON</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取3DTiles服务的tileset.json数据，后端接口：/igs/rest/services/{serviceName}/3DTilesServer/tileset.json</p></code></td>
                            </tr>
                            ...
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#queryTileMetadata">queryTileMetadata</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取IGS3DTiles服务的元数据，后端接口：/igs/rest/services/{serviceName}/3DTilesServer?f=json</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="getTileSetJSON">
        <a class="href-link" href="#getTileSetJSON">#</a>
        
        <span class="code-name" id="getTileSetJSON" style="font-size:30px">
            
                getTileSetJSON<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取3DTiles服务的tileset.json数据，后端接口：/igs/rest/services/{serviceName}/3DTilesServer/tileset.json</p>
    </div>
...
.then(function (result) {
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="queryTileMetadata">
        <a class="href-link" href="#queryTileMetadata">#</a>
        
        <span class="code-name" id="queryTileMetadata" style="font-size:30px">
            
                queryTileMetadata<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取IGS3DTiles服务的元数据，后端接口：/igs/rest/services/{serviceName}/3DTilesServer?f=json</p>
    </div>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>//回调方式
cesium3DTilesServer.queryTileMetadata({
  success: function (result) {
    console.log('请求成功：', result)
  }
})
