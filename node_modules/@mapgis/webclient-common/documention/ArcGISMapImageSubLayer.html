<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">ArcGISMapImageSubLayer</span>
...
<article>
    ...
    <h4 class="name" id="ArcGISMapImageSubLayer">
        <a class="href-link" href="#ArcGISMapImageSubLayer">#</a>
        
        <span class="code-name" id="ArcGISMapImageSubLayer" style="font-size:30px">
            
                new ArcGISMapImageSubLayer<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>图层的父图层对象</p></td>
</tr>
...
<span class="param-type">
             ...
             <a link="ArcGISMapImageSubLayer.html" onclick="getTypeHTML(event)" href="ArcGISMapImageSubLayer.html">ArcGISMapImageSubLayer</a>
                                ...
                                <td class="name"><code><p>通过json对象构造并返回一个IGSMapImageLayer对象</p></code></td>
                            </tr>
...
<span class="param-type">
    ...
    <div class="description">
        <p>通过json对象构造并返回一个IGSMapImageLayer对象</p>
    </div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>新的IGSMapImageLayer对象</p></div>
