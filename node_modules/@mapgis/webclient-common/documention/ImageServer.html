<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">ImageServer</span>
...
<article>
    ...
    <h4 class="name" id="ImageServer">
        <a class="href-link" href="#ImageServer">#</a>
        
        <span class="code-name" id="ImageServer" style="font-size:30px">
            
                new ImageServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>影像服务，服务地址：/igs/rest/services/{folder}/{serviceName}/ImageServer</p>
    </div>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取色表,后端接口:/igs/rest/services/{serviceName}/ImageServer/colorMap</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取直方图,后端接口:/igs/rest/services/{serviceName}/ImageServer/histograms</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取图例,后端接口：/igs/rest/services/{serviceName}/ImageServer/legend</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取栅格值,后端接口：/igs/rest/services/{serviceName}/ImageServer/rasterValue</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取统计信息，后端接口：/igs/rest/services/{serviceName}/ImageServer/statistics</p></code></td>
                            </tr>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取栅格数据信息 后端接口：/igs/rest/services/{serviceName}/ImageServer/info</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="getColorMap">
        <a class="href-link" href="#getColorMap">#</a>
        
        <span class="code-name" id="getColorMap" style="font-size:30px">
            
                getColorMap<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取色表,后端接口:/igs/rest/services/{serviceName}/ImageServer/colorMap</p>
    </div>
...
imageServer.getColorMap({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getHistograms">
        <a class="href-link" href="#getHistograms">#</a>
        
        <span class="code-name" id="getHistograms" style="font-size:30px">
            
                getHistograms<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取直方图,后端接口:/igs/rest/services/{serviceName}/ImageServer/histograms</p>
    </div>
...
imageServer.getHistograms({
  ...
  console.log('请求失败：', result);
    ...
    <div class="description">
        <p>获取图例,后端接口：/igs/rest/services/{serviceName}/ImageServer/legend</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>图例大小，格式：width,height</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>波段id列表</p></td>
</tr>
...
imageServer.getHistograms({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getRasterValue">
        <a class="href-link" href="#getRasterValue">#</a>
        
        <span class="code-name" id="getRasterValue" style="font-size:30px">
            
                getRasterValue<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取栅格值,后端接口：/igs/rest/services/{serviceName}/ImageServer/rasterValue</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>将查询的地理位置的x坐标值,必填</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>将查询的地理位置的y坐标值,必填</p></td>
</tr>
...
imageServer.getRasterValue({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getStatistics">
        <a class="href-link" href="#getStatistics">#</a>
        
        <span class="code-name" id="getStatistics" style="font-size:30px">
            
                getStatistics<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取统计信息，后端接口：/igs/rest/services/{serviceName}/ImageServer/statistics</p>
    </div>
...
imageServer.getStatistics({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="queryImageInfo">
        <a class="href-link" href="#queryImageInfo">#</a>
        
        <span class="code-name" id="queryImageInfo" style="font-size:30px">
            
                queryImageInfo<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取栅格数据信息 后端接口：/igs/rest/services/{serviceName}/ImageServer/info</p>
    </div>
