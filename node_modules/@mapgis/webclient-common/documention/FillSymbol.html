<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">FillSymbol</span>
...
<article>
    ...
    <h4 class="name" id="FillSymbol">
        <a class="href-link" href="#FillSymbol">#</a>
        
        <span class="code-name" id="FillSymbol" style="font-size:30px">
            
                new FillSymbol<span class="signature">(options)</span>
...
<span class="param-type">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>//将JS对象转换为JSON格式
let symbol = fillSymbol.toJSON();</code></pre>
