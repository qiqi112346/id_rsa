<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">WorkFlowServer600235</span>
...
<article>
    ...
    <h4 class="name" id="WorkFlowServer600235">
        <a class="href-link" href="#WorkFlowServer600235">#</a>
        
        <span class="code-name" id="WorkFlowServer600235" style="font-size:30px">
            
                new WorkFlowServer600235<span class="signature">(options)</span>
...
<span class="param-type">
  ...
  <td class="description last"><p>需转换的类的URL,必传,例如:GDBP://user:password @ serverName/gdbName /ds/ds06/sfcls/www.wl</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>结果类的URL,必传,例如:GDBP://user:password @ serverName/gdbName /ds/ds06/sfcls/www.wl</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>目的空间参照系的名称,必传,例如:高斯大地坐标系_西安80_36带3_北</p></td>
</tr>
...
<dl class="details">
    ...
    <h5>示例</h5>
        ...
        <pre class="prettyprint"><code>const workFlowServer600235 = WorkFlowServer.createWorkFlow({
...
<h4 class="name" id="clsName">
    <a class="href-link" href="#clsName">#</a>
...
<div class="description">
    <p>需转换的类的URL,必传,例如:GDBP://user:password @ serverName/gdbName /ds/ds06/sfcls/www.wl</p>
</div>
...
<h4 class="name" id="crsName">
    <a class="href-link" href="#crsName">#</a>
...
<div class="description">
    <p>目的空间参照系的名称,必传,例如:高斯大地坐标系_西安80_36带3_北</p>
</div>
...
<h4 class="name" id="desClsName">
    <a class="href-link" href="#desClsName">#</a>
...
<div class="description">
    <p>结果类的URL,必传,例如:GDBP://user:password @ serverName/gdbName /ds/ds06/sfcls/www.wl</p>
</div>
