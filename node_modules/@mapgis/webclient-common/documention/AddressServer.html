<header id="page-title" class="page-title">
        ...
        <span class="page-title-sub">AddressServer</span>
...
<article>
    ...
    <h4 class="name" id="AddressServer">
        <a class="href-link" href="#AddressServer">#</a>
        
        <span class="code-name" id="AddressServer" style="font-size:30px">
            
                new AddressServer<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>地址服务，基地址：/igs/rest/services/{folder}/{serviceName}/AddressServer</p>
    </div>
            ...
            <div class="table-container">
                <table class="params table">
                    ...
                    <tbody>
                            ...
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#getGeoCode">getGeoCode</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取地理编码，后端接口：/igs/rest/services/{serviceName}/AddressServer/geocode</p></code></td>
                            </tr>
                        
                            <tr class="deep-level-0">
                                <td class="name"><code><a href="#getReverseGeoCode">getReverseGeoCode</a></code></td>
                                <td class="name">
                                    <code>
...
<span class="param-type">
         ...
         Promise.&lt;Object>
                                ...
                                <td class="name"><code><p>获取逆地理编码,后端接口：/igs/rest/services/{serviceName}/AddressServer/reverseGeocode</p></code></td>
                            </tr>
    ...
    <h4 class="name" id="getGeoCode">
        <a class="href-link" href="#getGeoCode">#</a>
        
        <span class="code-name" id="getGeoCode" style="font-size:30px">
            
                getGeoCode<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取地理编码，后端接口：/igs/rest/services/{serviceName}/AddressServer/geocode</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>地址,必填</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>province</code></td>
...
<span class="param-type">
  ...
  <td class="description last"><p>指定查询的省</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>指定查询的市</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>指定查询的区/县</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>几何过滤信息</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>属性过滤条件，示例：hotGroup='社区'</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>aggLevel</code></td>
...
<span class="param-type">
  ...
  <td class="description last"><p>聚合等级，默认5</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>aggFormat</code></td>
...
<span class="param-type">
  ...
  <td class="description last"><p>聚合结果格式，默认1（1--返回hash、矩形，其他返回hash、中心点）</p></td>
</tr>
...
<tr class="deep-level-1">
      ...
      <td class="name"><code>fuzzy</code></td>
...
<span class="param-type">
  ...
  <td class="description last"><p>是否模糊，默认为true</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>分页参数，页码，默认1</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>分页参数，每页大小，默认100</p></td>
</tr>
...
addressServer.getGeoCode({
  ...
  console.log('请求失败：', result);
    ...
    <h4 class="name" id="getReverseGeoCode">
        <a class="href-link" href="#getReverseGeoCode">#</a>
        
        <span class="code-name" id="getReverseGeoCode" style="font-size:30px">
            
                getReverseGeoCode<span class="signature">(options)</span>
    ...
    <div class="description">
        <p>获取逆地理编码,后端接口：/igs/rest/services/{serviceName}/AddressServer/reverseGeocode</p>
    </div>
...
<span class="param-type">
  ...
  <td class="description last"><p>坐标，格式 x,y，必填</p></td>
</tr>
...
<span class="param-type">
  ...
  <td class="description last"><p>搜索半径,默认单位是千米,默认为0.1</p></td>
</tr>
