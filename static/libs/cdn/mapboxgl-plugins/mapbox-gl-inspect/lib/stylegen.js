export function circleLayer(color, source, vectorLayer) {
  var layer = {
...
export function polygonLayer(color, outlineColor, source, vectorLayer) {
  var layer = {
...
export function lineLayer(color, source, vectorLayer) {
  var layer = {
 ...
 */
 export function generateColoredLayers(sources, assignLayerColor) {
  var polyLayers = [];
  var circleLayers = [];
  var lineLayers = [];
 ...
 */
 export function generateInspectStyle(originalMapStyle, coloredLayers, opts) {
  opts = Object.assign({
    backgroundColor: '#fff'
  }, opts);
...
export default generateInspectStyle;